...
def test_read_data():
    ...
    assert not X.empty  # Esta é uma maneira preguiçosa de fazer Try Catch...
    assert not y.empty   # Se o teste com o assert não der certo, o código Python para!
...
def test_create_model():
    ...
    """
    X, _ = read_data() #U Usar o underscore _ faz retornar apenas o X do read_data() que retornaria X e y
